...
class Surrounding:
    ...
    def get_surroundings(self):
        ...
        self.get_edge_list()
        self.get_edge_dict()
        self.get_edge_length_list()
        self.get_edge_length_dict()
        self.get_max_speed_list()
